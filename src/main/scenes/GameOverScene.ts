...
export class GameOverScene extends Scene<ThisIsMyDepartmentApp> {
    @asset(STANDARD_FONT)
    ...
    public setup() {
        ...
        const confirmKey = this.input.currentControllerFamily === ControllerFamily.GAMEPAD ? "A" : "Enter";
        this.textNode
            .setText(`按${confirmKey}键返回菜单`)
